...
resource "aws_cloudfront_origin_access_control" "serverlessapptestbucket-oac" {
  name                              = "serverlessapptestbucket.s3.us-east-1.amazonaws.com"
...
resource "aws_cloudfront_distribution" "serverlesstestapp" {
  default_cache_behavior {
    ...
    target_origin_id       = "serverlessapptestbucket.s3.us-east-1.amazonaws.com"
  ...
  origin {
    ...
    domain_name         = "serverlessapptestbucket.s3.us-east-1.amazonaws.com"
    origin_id           = "serverlessapptestbucket.s3.us-east-1.amazonaws.com"
  }
